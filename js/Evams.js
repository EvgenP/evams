function summa() {
    ...
    function calc(ansD) {
        if (ansD.value < 1) {
            ...
            imag.setAttribute("src", "./img/1.png")
        } else if (ansD.value > 40 && ansD.value < 49) {
            imag.setAttribute("src", "./img/2.png")
        } else if (ansD.value > 50 && ansD.value < 59) {
            imag.setAttribute("src", "./img/3.png")
        } else if (ansD.value > 60 && ansD.value < 69) {
            imag.setAttribute("src", "./img/4.png")
        } else if (ansD.value > 70) {
            imag.setAttribute("src", "./img/5.png")
        };
    };
...
function risk() {
    document.getElementById("risk").setAttribute("src", "./img/8.png")
    document.getElementById('risk').setAttribute("src", "./img/9.png")
};